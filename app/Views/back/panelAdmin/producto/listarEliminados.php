<div id="layourSidenav_content">
    <main>
        ...
        <div class="container-fluid">
            <p>
                <a href="<?php echo base_url('panelAdmin/producto/listar');?>" class="btn btn-primary">Activos</a>
                    ...
                    <?php foreach($productos as $producto): ?>
                        <tr>
                            ...
                            <td class="btn-group-vertical" role="group">
                                ...
                                <a class="btn btn-success" href="<?php echo base_url('producto/activar/'.$producto['id']);?>">ACTIVAR</a>
                                <?php if($producto['destacado'] == 0) : ?>
