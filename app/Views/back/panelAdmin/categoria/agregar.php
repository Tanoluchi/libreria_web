...
<div id="layourSidenav_content">
    <main>
        ...
        <div class="container-fluid">
            <form method="post" action="<?php echo base_url('panelAdmin/categoria/guardar') ?>" class="g-3 needs-validation" novalidate>
                <div class="form-group row g-3">
                    <div class="col-12">
                        <label class="mb-2" for="nombre">Nombre</label>
                        <input class="form-control w-50" type="text" id="nombre" name="nombre" autofocus>
                    ...
                    <div class="col-12">
                        ...
                        <textarea class="form-control w-50" id="descripcion" rows="3" name="descripcion"></textarea>
